...
public class review_PageDTO {
	private int currentPage; // 현재페이지
	private int totalCount; // 총 레코드수
	private int blockCount = 11; // 한 페이지에 보여줄 레코드수
	...
	public review_PageDTO() {

	}
	
	public review_PageDTO(int totalCount){
		  //총페이지수
				totalPage=totalCount/blockCount+(totalCount%blockCount==0?0:1);
	}

	public review_PageDTO(int currentPage, int totalCount) {
