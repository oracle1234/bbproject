...
<strong>약관동의</strong>
<input type="radio" name="agree">이용약관에 동의 합니다.
<input type="radio" name="agree">이용약관에 동의하지 않습니다.
<div class="agreeinfo">
<span>
제1조(목적)
이 약관은 (주)반찬을부탁해(전자상거래 사업자)(이)가 운영하는 반찬을 부탁해(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」
제2조(정의)
① "몰" 이란 (주)반찬을부탁해(이)가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
재화등의 검색 및 선택, 구매자의 성명, 주소, 전화번호, 이동전화번호, 전자우편주소와 재화등을 받는 자의 성명, 주소, 전화번호, 이동전화번호, 희망수령일, 서비스제품선택, 새벽직배송 필수정보, 주변 랜드마크 정보나 배송 특이 요청사항, 더반찬에게 할말 등의 입력
...
필수 사항 : 성명, 성별, 회원ID(회원의 경우), 비밀번호(회원의 경우), 전자우편주소, 이동전화번호(휴대폰 번호), 생년월일, 주소, 희망수령일, 새벽직배송 필수정보, 결제수단, 입금자명
선택 사항 : 추천인 아이디, 현금영수증 신청용 핸드폰번호
주소
전화번호
희망ID(회원의 경우)
비밀번호(회원의 경우)
...
④ "몰"이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 정보통신망이용촉진등에관한법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.
...
<input type="radio" name="private">개인정보취급방침에 동의 합니다.
<input type="radio" name="private">개인정보취급방침에 동의하지 않습니다.
<div class="privateinfo">
<span>
'(주)반찬을부탁해'은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
수집하는 개인정보 항목
회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
수집항목
- 필수 항목 : 성명, 생년월일, 연락처(휴대전화번호, 전화번호), 이메일, 성별, 방문일시, 서비스이용기록, 온라인상담기록, OS버전, 단말기 기기명
- 선택 항목 : 공동현관 비밀번호, 집 약도
개인정보 수집방법
- 홈페이지 (회원가입, 고객센터 게시판), 구매시 정보입력, 이벤트참여 및 고객센터를 통한 전화 또는 온라인 상담
개인정보의 수집 및 이용목적
...
<div class="allagree">
<input type="checkbox" name="allagree">회원가입 정보정책(이용약관/개인정보취급방침)에 모두 동의합니다.
</div>
<div class="button">
